...
public class RegexChk {
     ...
     */
//    public boolean checkPhone(String cellPhoneNr) {
//        String reg = "0?1\\d{10}";
...
//    }
    ...
    public boolean checkPhone(String phone) {
        ...
        Pattern pattern2 = Pattern.compile("^14\\d{9}||15[8,9]\\d{8}$");
        Pattern pattern3 = Pattern.compile("^15\\d{9}||15[8,9]\\d{8}$");
        Pattern pattern4 = Pattern.compile("^16\\d{9}||15[8,9]\\d{8}$");
        Pattern pattern5 = Pattern.compile("^17\\d{9}||15[8,9]\\d{8}$");
        Pattern pattern6 = Pattern.compile("^18\\d{9}||15[8,9]\\d{8}$");
        ...
        Matcher matcher5 = pattern5.matcher(phone);
     ...
     * "密码由6-16位，数字和这字母组成"
     */
    public boolean checkIdPass(String idNr) {
    ...
    /**
     * "密码由6-18位，表示是字母或数字，或字母加数字"
     */
    public boolean checkIdPassNew(String idNr) {

        //String reg =("[a-zA-Z]+[0-9]+");
        String reg = "^[0-9a-zA-Z]{6,18}$";
        return startCheck(reg, idNr);
    }
     ...
     * @return
     */
    public boolean checkIdPassNull(String idNr) {
