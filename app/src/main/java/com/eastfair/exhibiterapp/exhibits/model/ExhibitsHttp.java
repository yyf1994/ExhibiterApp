package com.eastfair.exhibiterapp.exhibits.model;

/**
 * Created by yyf on 2016/5/9.
 */
public class ExhibitsHttp<T> {
    private ExhibitsHttp(){};

    private static class InstanceHolder{
        private static final ExhibitsHttp instance = new ExhibitsHttp();
    }

    public static ExhibitsHttp getInstance()
    {
