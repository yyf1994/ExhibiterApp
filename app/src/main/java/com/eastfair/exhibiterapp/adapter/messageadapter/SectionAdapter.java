package com.eastfair.exhibiterapp.adapter.messageadapter;
...
import com.eastfair.exhibiterapp.model.Section;
 ...
 */
public class SectionAdapter extends BaseGroupAdapter<Section, Characters> {
    ...
    public int getChildCount(int groupPosition) {
        List<Characters> characters = getGroup(groupPosition).getCharacters();
        return characters != null ? characters.size() : 0;
    }

    @Override
    protected Characters getChild(int groupPosition, int childPosition) {
    ...
    protected View getChildView(final int groupPosition, final int childPosition, View convertView, ViewGroup parent) {
        ...
        final Characters character = getChild(groupPosition, childPosition);
