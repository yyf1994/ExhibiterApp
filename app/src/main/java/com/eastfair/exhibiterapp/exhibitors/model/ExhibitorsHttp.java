package com.eastfair.exhibiterapp.exhibitors.model;

/**
 * Created by yyf on 2016/5/9.
 */
public class ExhibitorsHttp<T> {
    private ExhibitorsHttp(){};

    private static class InstanceHolder{
        private static final ExhibitorsHttp instance = new ExhibitorsHttp();
    }

    public static ExhibitorsHttp getInstance()
    {
